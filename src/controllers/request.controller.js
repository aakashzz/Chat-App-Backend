import {  deleteRequestService, newRequestCreateService, receiverAllRequestService, updateRequestStatus } from "../services/request.service.js";
...
const newRequestCreateController = async function(req,res){
    ...
    const newRequestCreated = await newRequestCreateService(senderId,receiverId);
    return res.status(200).json(
        new ApiResponse(200,newRequestCreated,"Request Created")
    )
}
...
const removeRequestController = async function(req,res){
    ...
    return res.status(201).json(
        new ApiResponse(201,[],"Request Delete SuccessFully")
    )
}

export {newRequestCreateController,receiveAllRequestController,updateRequestStatusController,removeRequestController}